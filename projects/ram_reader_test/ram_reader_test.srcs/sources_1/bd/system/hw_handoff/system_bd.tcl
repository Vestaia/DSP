...
proc create_root_design { parentCell } {
  ...
  set axis_ram_reader_0 [ create_bd_cell -type ip -vlnv user.org:user:axis_ram_reader:1.0 axis_ram_reader_0 ]
  ...
  connect_bd_intf_net -intf_net axis_ram_reader_0_m_axi [get_bd_intf_pins axis_ram_reader_0/m_axi] [get_bd_intf_pins ps_0/S_AXI_HP0]
  ...
  connect_bd_net -net Net [get_bd_pins axis_ram_reader_0/aresetn] [get_bd_pins rst_0/ext_reset_in] [get_bd_pins xlconstant_0/dout]
  ...
  connect_bd_net -net axis_ram_reader_0_m_axi_arid [get_bd_pins axis_ram_reader_0/m_axi_arid] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net pll_0_clk_out1 [get_bd_pins axis_ram_reader_0/aclk] [get_bd_pins pll_0/clk_out1] [get_bd_pins ps_0/M_AXI_GP0_ACLK] [get_bd_pins ps_0/S_AXI_HP0_ACLK] [get_bd_pins rst_0/slowest_sync_clk]
  connect_bd_net -net pll_0_locked [get_bd_pins pll_0/locked] [get_bd_pins rst_0/dcm_locked]
  connect_bd_net -net ps_0_S_AXI_HP0_RLAST [get_bd_pins axis_ram_reader_0/m_axi_rlast] [get_bd_pins ps_0/S_AXI_HP0_RLAST] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net ps_0_S_AXI_HP0_RVALID [get_bd_pins axis_ram_reader_0/m_axi_rvalid] [get_bd_pins ps_0/S_AXI_HP0_RVALID] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net xlconcat_0_dout [get_bd_ports led_o] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins axis_ram_reader_0/cfg_data] [get_bd_pins xlconstant_1/dout]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axis_ram_reader_0/m_axi] [get_bd_addr_segs ps_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
