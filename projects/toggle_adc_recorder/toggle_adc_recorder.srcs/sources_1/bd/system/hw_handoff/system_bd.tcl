...
# Hierarchical cell: system_configuration
proc create_hier_cell_system_configuration { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_system_configuration() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: filter_reset, and set properties
  set filter_reset [ create_bd_cell -type ip -vlnv pavel-demin:user:port_slicer:1.0 filter_reset ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {1} \
   CONFIG.DIN_TO {1} \
  ...
  # Create instance: gen_exp_decay, and set properties
  set gen_exp_decay [ create_bd_cell -type ip -vlnv pavel-demin:user:port_slicer:1.0 gen_exp_decay ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {0} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {4096} \
  ...
  connect_bd_net -net cfg_0_cfg_data [get_bd_pins cfg_0/cfg_data] [get_bd_pins filter_reset/din] [get_bd_pins gen_exp_decay/din] [get_bd_pins port_slicer_0/din] [get_bd_pins port_slicer_1/din] [get_bd_pins writer_reset/din]
  connect_bd_net -net gen_exp_decay_dout [get_bd_pins dout4] [get_bd_pins gen_exp_decay/dout]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins c_counter_binary_0/Q] [get_bd_pins port_slicer_4/din] [get_bd_pins xlconcat_0/In0]
  ...
  connect_bd_net -net pulse_gen_0_pulse [get_bd_pins mult_gen_0/A] [get_bd_pins pulse_gen_0/pulse]
  ...
  connect_bd_net -net slice_2_dout [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins not_0/Op1] [get_bd_pins sig_exp_decay_0/rst] [get_bd_pins system_configuration/dout1] [get_bd_pins writer_0/s_axis_tvalid] [get_bd_pins writer_1/s_axis_tvalid] [get_bd_pins xlconcat_2/In1]
  ...
  connect_bd_net -net system_configuration_dout4 [get_bd_pins mult_gen_0/B] [get_bd_pins system_configuration/dout4]
