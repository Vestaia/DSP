...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.CONST_VAL {5151} \
   CONFIG.CONST_WIDTH {64} \
 ] $xlconstant_0

  # Create interface connections
  connect_bd_intf_net -intf_net axis_constant_0_M_AXIS [get_bd_intf_pins axis_constant_0/M_AXIS] [get_bd_intf_pins writer_0/S_AXIS]
  ...
  connect_bd_net -net cfg_0_cfg_data [get_bd_pins cfg_0/cfg_data] [get_bd_pins slice_3/din]
  ...
  connect_bd_net -net pll_0_clk_out1 [get_bd_pins axis_constant_0/aclk] [get_bd_pins cfg_0/aclk] [get_bd_pins pll_0/clk_out1] [get_bd_pins ps_0/M_AXI_GP0_ACLK] [get_bd_pins ps_0/S_AXI_HP0_ACLK] [get_bd_pins ps_0_axi_periph/ACLK] [get_bd_pins ps_0_axi_periph/M00_ACLK] [get_bd_pins ps_0_axi_periph/S00_ACLK] [get_bd_pins rst_0/slowest_sync_clk] [get_bd_pins writer_0/aclk]
  ...
  connect_bd_net -net slice_3_dout [get_bd_pins slice_3/dout] [get_bd_pins writer_0/aresetn]
