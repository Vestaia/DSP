...
HD_PWD='/home/koko/git/DSP/cores/axis/MSE/MSE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MSE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MSE.tcl
