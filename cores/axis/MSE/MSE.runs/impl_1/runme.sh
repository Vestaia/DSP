...
HD_PWD='/home/koko/git/DSP/cores/axis/MSE/MSE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MSE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MSE.tcl -notrace
